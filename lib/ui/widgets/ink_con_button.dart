...
/// widget whose child is an [InkIconButton]. The icon button's filled background
...
class InkIconButton extends StatelessWidget {
  ...
  /// [Icon.size] property allows the [InkIconButton] to size the splash area to
  /// fit the [Icon]. If you were to set the size of the [Icon] using
  /// [Icon.size] instead, then the [InkIconButton] would default to 24.0 and then
